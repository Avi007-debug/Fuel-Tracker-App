...
- [ ] Onboarding flow UI + VehicleProfile save [P0] (5h)
...
- [ ] Petrol price HTTP fetch + HTML parser [P0] (5h)
- [ ] Fuel entry — manual price fallback UI [P0] (2h)
- [ ] Fuel entry — Litres direct mode (bottom sheet) [P0] (2h)
- [x] Tank Full checkbox + flag in FuelEntry model [P1] (1h)
- [ ] Attach receipt photo to fuel entry [P2] (3h)
...
- [ ] Service reminder engine (km tracking per 5 types) [P0] (4h)
- [x] Cost per km calculator [P0] (2h)
- [ ] Petrol price trend & moving average [P1] (2h)
...
- [ ] Implement all 18 charts (fl_chart) [P0] (16h)
  ...
  - [ ] Monthly Expense Forecast (Area)
- [x] Vehicle Health Score gauge (categorised: Efficiency, Maintenance, Consistency) [P1] (3h)
- [ ] Service status panel on Insights screen [P1] (3h)
- [x] Monthly summary card [P0] (2h)

### Phase 4: Notifications & Background (Week 11) — ~18h
- [ ] Morning trip reminder (7:30 AM, weekdays, skip if logged) [P0] (3h)
- [ ] Evening return reminder (6:00 PM) [P0] (2h)
- [ ] Evening escalation (every 10 min until 10 PM) [P1] (3h)
- [ ] Low fuel alert notification (range < 40 km) [P0] (2h)
- [ ] Service due alerts (all 5 types) [P0] (3h)
- [ ] Workmanager periodic analytics recalculation [P1] (3h)
- [ ] Boot receiver (reschedule notifications on boot) [P1] (2h)
